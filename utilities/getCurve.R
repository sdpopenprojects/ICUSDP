...
library("effsize")
#source("my_ESD.R")
source("E:/ICUSDP-main/ICUSDP-main/utilities/my_ESD1.R")
...
#input_path <- "E:/ICUSDP-main/ICUSDP-main/new2/dataall_unsupervised/"
input_path <- "E:/ICUSDP-main/ICUSDP-main/new2/dataall_supervised/"

# 输出目录
#result_dir <- "F:/ICUSDP/INTC/ICUSDP/W_C_test/visual/visual_result/SDP VS USDP/"
#result_dir <- "E:/ICUSDP-main/ICUSDP-main/new2/USDP/"
result_dir <- "E:/ICUSDP-main/ICUSDP-main/new2/SDP/"
...
for (meas_idx in seq(meas)) {
  ...
  # NA 缺失防报错处理（针对 MUSDP 未包含的指标列）
  for (col_i in seq(ncol(data))) {
    if (all(is.na(data[[col_i]]))) {
      data[[col_i]][is.na(data[[col_i]])] <- 0
    }
  }
  
  #mnames <- c('ICUSDP', 'KMedoids', 'MU', 'MD', 'SC', 'TCL', 'TCLP', 'CLA', 'CLAMI', 'ONE', 'DT', 'RF', 'GBM', 'XGBoost', 'LR', 'linearSVM')
  #mnames <- c('ICUSDP', 'KMedoids', 'MUSDP', 'MU', 'MD', 'SC', 'TCL', 'TCLP', 'CLA', 'CLAMI', 'ONE')
  ...
  #mnames2 <- c('ICUSDP', 'KMedoids', 'MUSDP', 'MU', 'MD', 'SC', 'TCL', 'TCLP', 'CLA', 'CLAMI', 'ONE')
