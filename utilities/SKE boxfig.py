...
INPUT_DIR = r"E:\ICUSDP\INTC\ICUSDP\W_C_test\statistic\all_over1"
SK_SUPERVISED_DIR = r"E:\ICUSDP\INTC\ICUSDP\W_C_test\visual\SKESD\SDP"
SK_UNSUPERVISED_DIR = r"E:\ICUSDP\INTC\ICUSDP\W_C_test\visual\SKESD\USDP"
OUTPUT_DIR = r"E:\ICUSDP\INTC\ICUSDP\W_C_test\visual\SKESD\SDP VS USDP"
MAIN_MODEL = 'ICUSDP'
...
def plot_boxplot_split(df, metric_name, save_dir):
    ...
    # 将 KMedoids 替换为 MUSDP
    unsupervised_models = ['CLA', 'CLAMI', 'MUSDP', 'MD', 'MU', 'SC', 'TCL', 'TCLP', 'ONE']
