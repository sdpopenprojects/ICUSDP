...
# ==================== 1. 定义指定的绝对路径 ====================
input_dir = r"E:\ICUSDP\INTC\ICUSDP\W_C_test\visual\Radar"
output_dir = r"E:\ICUSDP\INTC\ICUSDP\W_C_test\visual\Radar"

excel_path = os.path.join(input_dir, "all_addMUSDP.xlsx")
output_pdf_path = os.path.join(output_dir, "Radar_Comparison_addMUSDP.pdf")
...
# ==================== 3. 划分三大阵营并计算中位数 ====================
# 🔥 核心修改点：将 KMedoids 替换为 MUSDP
unsupervised_list = ['ONE', 'CLA', 'CLAMI', 'MUSDP', 'MD', 'MU', 'SC', 'TCL', 'TCLP']
...
print(f"🎉 【大字号包含 MUSDP 的雷达图绘制成功】已无损导出至: {output_pdf_path}")
plt.show()