...
def load_pkl_files(base_dir='F:/ICUSDP/INTC/ICUSDP/result_20260526_VAE/clustering/INTC_KMEANS/reports'):
    """
    加载所有pkl文件
    """
...
def create_heatmap_visualization(all_data_list, common_features, top_features, save_dir='./analysis_results/'):
    ...
    plt.xticks(range(top_n), top_features, rotation=45, ha='right', fontsize=20)
    plt.yticks(range(n_files), file_labels, fontsize=18)
...
def main():
    ...
    base_dir = 'F:/ICUSDP/INTC/ICUSDP/result_20260526_VAE/clustering/INTC_KMEANS/reports'
    ...
    output_dir = 'F:/ICUSDP/INTC/ICUSDP/result_20260526_VAE/feature_analysis_results_top15/'
